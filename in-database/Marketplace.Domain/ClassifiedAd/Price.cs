...
public sealed class Price : Money
{
  ...
  internal Price(decimal amount, string currencyCode, bool inUse,
    int decimalPlaces) : base(amount, new CurrencyDetails(currencyCode, inUse,
      decimalPlaces))
  {
  }
  ...
  public static new Price FromDecimal(decimal amount, string currencyCode,
